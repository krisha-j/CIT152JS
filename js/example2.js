...
var firstTwoItems = document.querySelector

// ADD A CLASS OF hot TO first two LIST ITEMS
 var i;                                                             // Counter variable
    for (i = 0; i < 2; i++) {                                      // Loop through elements
  listItems[i].className = 'hot';                                 // Change class to hot
  
  // ADD A CLASS OF COOL TO last three LIST ITEMS
/*var j;                                                             // Counter variable
    for (j = 3; j < 5; j++) {                                   // Loop through elements
  listItems[j].className = 'cool';       */                         // Change class to cool
}
